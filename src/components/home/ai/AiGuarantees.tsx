...
const FAQ = [
  ...
  },
  {
    ...
    a: "Все права переходят вам по завершении проекта — без дополнительной оплаты за лицензию.",
  },
  {
    q: "Куда уходят наши данные?",
    a: "Конфиденциальность фиксируем в NDA до начала работы, а не после. Что можно использовать, а что остаётся строго внутри проекта — прописываем в договоре заранее.",
  },
];
