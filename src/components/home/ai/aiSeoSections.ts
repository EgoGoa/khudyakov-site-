...
export const AI_SEO_SECTIONS: SeoSection[] = [
  ...
  {
    title: "Почему HUD.SERVICE",
    body: "AI-направление растёт внутри сервиса с полным циклом видеопродакшна и продакшн-культурой — 8 лет на рынке, 350+ клиентов, около 60% заказов — от тех, кто возвращается. AI-инструменты внедряем с 2024 года: не потому что модно, а там, где они реально ускоряют результат клиента.",
  },
];
