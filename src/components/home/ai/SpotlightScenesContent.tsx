    ...
    <Frame>
      ...
      {goals.map((g, i) => (
        <In key={g} at={1 + i}>
          ...
          <text x="38" y={81.5 + i * 32} fill={`${W}0.85)`} fontSize="13.2" fontFamily="inherit">{g}</text>
      ...
      <In at={4}>
        ...
        <text x="185" y="86" textAnchor="middle" fill={`${W}0.5)`} fontSize="10.1" letterSpacing="1.2" fontFamily="inherit">СЦЕНАРИЙ</text>
        {[0, 1, 2, 3, 4].map((i) => (
  ...
  return (
    <Frame>
      ...
      <In at={5}>
        ...
        <text x="193" y="98" textAnchor="middle" fill="#fff" fontSize="10.9" letterSpacing="1.2" fontFamily="inherit">ГРАФИКА</text>
      </In>
      <In at={6}>
        ...
        <text x="276" y="83" fill={`${W}0.8)`} fontSize="12.4" fontFamily="inherit">камера</text>
        <text x="258" y="102" fill={`${W}0.5)`} fontSize="10.9" fontFamily="inherit">на площадке</text>
  ...
  return (
    <Frame>
      ...
      <In at={1}>
        ...
        <text x="52" y="152" textAnchor="middle" fill={`${W}0.5)`} fontSize="10.1" letterSpacing="1.2" fontFamily="inherit">ИСХОДНИК</text>
      </In>
      {outs.map((o, i) => (
        <In key={o.name} at={2 + i}>
          ...
          <text x="270" y={83.5 + i * 34} fill="#fff" fontSize="12.4" fontWeight="600" fontFamily="inherit">{o.name}</text>
      ...
      <In at={1}>
        ...
        {["ссылка", "просмотр", "встреча"].map((t, i) => (
          <g key={t}>
            ...
            <text x={50 + i * 120} y="158" textAnchor="middle" fill={`${W}0.6)`} fontSize="11.6" fontFamily="inherit">{t}</text>
          </g>
        ))}
      </In>
      <In at={2}>
  ...
  return (
    <Frame>
      ...
      <In at={1}>
        ...
        <text x="55" y="76" textAnchor="middle" fill="var(--sp-from)" fontSize="10.9" letterSpacing="1.2" fontFamily="inherit">3 СЕК</text>
      </In>
      <In at={2}>
      ...
      {outs.map((o, i) => {
        ...
        return (
          <In key={o.l} at={2 + i}>
            ...
            <text x={px + o.w / 2} y={110 + o.h / 2 + 8} textAnchor="middle" fill={`${W}0.6)`} fontSize="10.9" fontFamily="inherit">{o.l}</text>
          </In>
        );
      })}
    ...
    <Frame>
      ...
      {nodes.map((n, i) => (
        <In key={n} at={2 + i}>
          ...
          <text x={40 + i * 65} y="117.5" textAnchor="middle" fill="#fff" fontSize="14.0" fontWeight="600" fontFamily="inherit">{i + 1}</text>
          <text x={40 + i * 65} y="146" textAnchor="middle" fill={`${W}0.75)`} fontSize="12.4" fontFamily="inherit">{n}</text>
        </In>
      ))}
      <In at={7}>
  ...
  return (
    <Frame>
      ...
      <In at={1}>
        ...
        <text x="70" y="176" textAnchor="middle" fill={`${W}0.4)`} fontSize="10.9" fontFamily="inherit">перечень фактов</text>
      </In>
      <In at={2}>
  ...
  return (
    <Frame>
      ...
      <In at={5}>
        ...
        <text x="30" y="148" fill="#fff" fontSize="46.6" fontWeight="700" fontFamily="inherit">Aa</text>
    ...
    <Frame>
      ...
      {langs.map((l, i) => (
        <In key={l} at={2 + i}>
          ...
          <text x="176" y={82 + i * 24} fill="#fff" fontSize="13.2" fontWeight="700" fontFamily="inherit">{l}</text>
  ...
  return (
    <Frame>
      ...
      <In at={5}>
        ...
        <text x="266" y="92" textAnchor="middle" fill={`${W}0.55)`} fontSize="10.9" letterSpacing="1.2" fontFamily="inherit">ВИД ИЗНУТРИ</text>
        {[0, 1, 2].map((i) => (
    ...
    <Frame>
      ...
      {parts.map((p, i) => (
        <In key={i} at={2 + i}>
          ...
          <text x="262" y={p.y + p.h / 2 + 3} fill={`${W}0.75)`} fontSize="12.4" fontFamily="inherit">{["Корпус", "Механизм", "Основание"][i]}</text>
        </In>
      ))}
      <In at={5}>
  ...
  return (
    <Frame>
      ...
      <In at={5}>
        ...
        <text x="170" y="176" textAnchor="middle" fill="#fff" fontSize="14.0" letterSpacing="3" fontFamily="inherit">BRAND</text>
      </In>
    ...
    <Frame>
      ...
      {bids.map((h, i) => (
        <In key={i} at={1 + i * 0.7}>
          ...
          <text x={61 + i * 66} y="176" textAnchor="middle" fill={`${W}0.5)`} fontSize="10.9" fontFamily="inherit">{i === 3 ? "вы" : `заявка ${i + 1}`}</text>
        </In>
      ))}
      <In at={5}>
    ...
    <Frame>
      ...
      {tracks.map((t, i) => (
        <In key={t} at={1 + i}>
          ...
          <text x="26" y={82 + i * 32} fill="#fff" fontSize="12.4" fontWeight="600" fontFamily="inherit">{t}</text>
  ...
  return (
    <Frame>
      ...
      <In at={1}>
        ...
        <text x="26" y="88" fill={`${W}0.5)`} fontSize="10.9" letterSpacing="1.2" fontFamily="inherit">БРИФ</text>
        {["Продукт", "Площадки", "Срок"].map((t, i) => (
          <g key={t}>
            <circle cx="28" cy={102 + i * 16} r="3" fill="var(--sp-from)" />
            <text x="37" y={105 + i * 16} fill={`${W}0.8)`} fontSize="12.4" fontFamily="inherit">{t}</text>
          </g>
        ))}
      </In>
      <In at={2}>
      ...
      <In at={3}>
        ...
        <text x="196" y="94" textAnchor="middle" fill="#fff" fontSize="14.0" fontWeight="600" fontFamily="inherit">Идея</text>
      </In>
      <In at={4}>
  ...
  return (
    <Frame>
      ...
      <In at={1}>
        ...
        <text x="100" y="122" textAnchor="middle" fill="#fff" fontSize="31.0" fontWeight="700" fontFamily="inherit">60%</text>
      </In>
      {["Вернулись", "Порекомендовали", "Новые"].map((t, i) => (
        <In key={t} at={2 + i}>
          ...
          <text x="200" y={92.5 + i * 30} fill="#fff" fontSize="13.2" fontFamily="inherit">{t}</text>
        </In>
      ))}
  ...
  return (
    <Frame>
      ...
      <In at={2}>
        ...
        <text x="196" y="129" textAnchor="middle" fill="#fff" fontSize="12.4" fontWeight="600" fontFamily="inherit">ролик открыт</text>
      </In>
      <In at={3}>
        <text x="30" y="178" fill={`${W}0.45)`} fontSize="10.9" fontFamily="inherit">первый контакт</text>
        <text x="316" y="178" textAnchor="end" fill={`${W}0.45)`} fontSize="10.9" fontFamily="inherit">выбор</text>
      </In>
  ...
  return (
    <Frame>
      ...
      <In at={1}>
        ...
        <text x="66" y="116" textAnchor="middle" fill={`${W}0.4)`} fontSize="11.6" fontFamily="inherit">эскиз</text>
      </In>
      <In at={2}>
        ...
        <text x="130" y="114" textAnchor="middle" fill="#fff" fontSize="11.6" fontFamily="inherit">AI</text>
      </In>
      <In at={3}>
  ...
  return (
    <Frame>
      ...
      <In at={1}>
        ...
        <text x="26" y="82" fill="var(--sp-from)" fontSize="11.6" letterSpacing="1.2" fontFamily="inherit">AI УМЕСТЕН</text>
      </In>
      {good.map((t, i) => (
        <In key={t} at={2 + i * 0.6}>
          <path d={`M 26 ${98 + i * 22} l 4 4 l 8 -9`} stroke="var(--sp-from)" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
          <text x="46" y={102 + i * 22} fill="#fff" fontSize="13.2" fontFamily="inherit">{t}</text>
        </In>
      ))}
      <In at={4}>
        <rect x="174" y="66" width="152" height="98" rx="12" {...SOFT} />
        <text x="186" y="82" fill={`${W}0.5)`} fontSize="11.6" letterSpacing="1.2" fontFamily="inherit">НУЖНА КАМЕРА</text>
      </In>
      {cam.map((t, i) => (
        <In key={t} at={5 + i * 0.6}>
          <circle cx="192" cy={99 + i * 22} r="3.4" fill={`${W}0.45)`} />
          <text x="204" y={102 + i * 22} fill={`${W}0.85)`} fontSize="13.2" fontFamily="inherit">{t}</text>
        </In>
      ))}
  ...
  return (
    <Frame>
      ...
      <In at={6}>
        ...
        <text x="170" y="81" textAnchor="middle" fill="#fff" fontSize="11.6" fontFamily="inherit">нагрев 900 °C</text>
  ...
  return (
    <Frame>
      ...
      <In at={1}>
        ...
        <text x="90" y="122" textAnchor="middle" fill="#fff" fontSize="24.8" fontWeight="700" fontFamily="inherit">0:40</text>
      </In>
      {["Что это", "Как устроено", "Что даёт"].map((t, i) => (
        <In key={t} at={2 + i}>
          <rect x="160" y={74 + i * 30} width="166" height="22" rx="11" {...SOFT} />
          <text x="174" y={88.5 + i * 30} fill="#fff" fontSize="13.2" fontFamily="inherit">{i + 1}. {t}</text>
