...
// The shared skeleton for /sites' chapters, extracted once chapter 01's
// composition was approved and Egor asked for it across the whole page.
//
...
// which is the part that took a `headless` CinematicSection to make possible
// — see SitesPitch for why the section's own header could not stay.
//
...
export default function SitesChapterLayout({
   ...
   *  to control the line break and pick out the keyword, the way chapter 01
   *  sets "Сайты на AI —/дни, не месяцы". */
  title: ReactNode;
  sub: string;
  ...
  /** Left column width at lg. Chapter 01 runs wider (46%) because its
   *  carousel is narrower than the other chapters' panels. */
 ...
 *  carousel cards and chapter 02's comparison table, so the right-hand column
 *  reads as one material across the page. */
export const SITES_PANEL =
