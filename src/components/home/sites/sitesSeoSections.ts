...
export const SITES_SEO_SECTIONS: SeoSection[] = [
  ...
  },
  {
    ...
    body: "Направление сайтов на AI растёт внутри сервиса с продакшн-культурой полного цикла. Фиксированные сроки на старте, гарантия возврата денег, если результат не устроит, и код, который принадлежит вам — не чужому конструктору.",
  },
];
