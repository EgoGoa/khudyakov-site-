...
export default function ScrollTopButton() {
  ...
  return (
    <button
      ...
      className={`fixed right-[18px] land:right-[max(18px,calc(env(safe-area-inset-right)+0.5rem))] top-20 z-[64] grid h-9 w-9 place-items-center before:absolute before:-inset-1 before:content-[''] text-paper/70 transition-[opacity,transform,color] duration-500 hover:text-orange focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange sm:top-24 ${
