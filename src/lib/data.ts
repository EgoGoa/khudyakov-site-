...
export const services: Service[] = [
  {
    ...
    timeline: "7–14 дней",
    audience:
      "Бизнесам, которые готовят запуск нового продукта, сезонную распродажу или промо-кампанию и хотят ролик, который сразу ведёт к покупке, а не просто рассказывает о товаре.",
  },
  {
