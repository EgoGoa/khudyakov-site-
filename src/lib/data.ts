...
// budget/timeline/audience on every entry below are a first draft for
// Offer.tsx's per-service widget (see that component's own note) — numbers
// interpolated from pricingByCategory's three tiers further down this file,
// not real pricing Egor has signed off on. Flag them for his review before
// they go live anywhere client-facing beyond this internal check.
export const services: Service[] = [
  {
    title: "Продвижение товаров и услуг",
    description:
      "Ролик, который не рассказывает о продукте, а доводит до покупки. Работает связка из трёх вещей: эмоция, ритм монтажа и один точный посыл — не пять сразу.",
    budget: "75 000 – 255 000 ₽",
    timeline: "7–14 дней",
    audience:
      "Бизнесам на запуске нового продукта, сезонной распродаже или промо-кампании — когда ролик должен не «познакомить с товаром», а привести к кнопке «купить».",
  },
  {
    ...
    budget: "от 35 000 ₽ за пакет",
    timeline: "5–10 дней на партию",
    audience:
      "Брендам с активным присутствием в Instagram, Reels, YouTube и Telegram, которым нужен постоянный поток видео без падения качества при росте объёма.",
  },
  {
    ...
    timeline: "7–12 дней",
    audience:
      "Экспертам, коучам, врачам и предпринимателям, которые хотят превратить личную известность в доверие клиентов через живое видео, а не постановочные фото.",
  },
  {
    title: "3D/2D графика",
    description:
    ...
    timeline: "10–20 дней",
    audience:
      "Компаниям и продюсерским командам, которым нужна сложная инфографика, VFX или анимация логотипа — там, где обычная съёмка не решает задачу.",
  },
  {
    title: "Специальные проекты",
    description:
      "Нестандартные форматы под нестандартную задачу: от идеи и сценария до финального монтажа.",
    budget: "от 100 000 ₽, расчёт индивидуальный",
    timeline: "по ТЗ",
    audience:
      "Заказчикам с нестандартной задачей — от арт-объекта до иммерсивного шоу, — под которую нет готового шаблона и нужен индивидуальный сценарий.",
  },
  {
    ...
    timeline: "7–14 дней",
    audience:
      "Онлайн-школам, корпоративным университетам и HR-командам, которым нужен учебный контент, который реально досматривают до конца.",
  },
  {
    ...
    timeline: "14–25 дней",
    audience:
      "Артистам, лейблам и продюсерским центрам, которым нужен клип полного цикла — от концепции до релиза, а не просто отснятый материал.",
  },
  {
    ...
    timeline: "5–10 дней после съёмки",
    audience:
      "Организаторам конференций, фестивалей и корпоративных событий, которым важно показать масштаб и атмосферу для будущих партнёров и спонсоров.",
  },
  {
    ...
    timeline: "12–20 дней",
    audience:
      "Компаниям, которые готовят ребрендинг, выход на новый рынок или презентацию для инвесторов и хотят фильм, которому веришь.",
  },
  {
    ...
    budget: "20 000 – 120 000 ₽",
    timeline: "3–7 дней",
    audience:
      "Брендам, которым нужен большой объём контента в сжатые сроки — витрины товаров, аватары, генеративные ролики — без потери качества и узнаваемости.",
  },
];
