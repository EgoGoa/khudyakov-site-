...
//   08  47.21 → end    Close
//
// Вход на пять страниц AI-инструментов (/ai/agent и остальные) живёт не
// отдельной главой, а кнопкой прямо на карусели чапtera 01 (см. AiDeck.tsx)
// — Егор попросил держать это на первом блоке: «карусель остаётся, но
// чтобы через кнопку можно было нажимать на неё и проходить на отдельную
// страницу». Пять из десяти карточек ведут на свою страницу, остальные пять
// пока без страниц — кнопка появляется только там, где страница есть.
const PHASES: Phase[] = [
  { start: 0, end: 7.14 },
